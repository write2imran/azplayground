...
# Create app service plan (OS -linux, Pricing F1)  
- Export the template
...
# deployment of resources using parameter file for dev
...
# deployment of resources using parameter file for prod
...
# linked template cannot be access from local file or local network, it must be access through a URI

# deploy template to storage account using SAS token
...
# CI integration of ARM templates with Azure pipelines
